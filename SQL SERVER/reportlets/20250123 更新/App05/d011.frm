...
WHERE 1 = 1
	...
	AND T1.CURRENCY_CODE IS NOT NULL]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
</TableDataMap>
...
<Parameters/>
<Content>
<![CDATA[let reader = this.options.form.getWidgetByName("P_READER").getValue();
let submit = this.options.form.getWidgetByName("BTN_SUBMIT")
if (reader != '0') {
...
<BoundsAttr x="1038" y="40" width="218" height="26"/>
</Widget>
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
...
<Parameters/>
<Content>
<![CDATA[window.iframe_r70.verifyAndWriteReport();]]></Content>
</JavaScript>
</Listener>
...
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.form.ui.FreeButton">
<Listener event="click" name="p">
<JavaScript class="com.fr.js.JavaScriptImpl">
<Parameters/>
<Content>
<![CDATA[var iframe = $("<iframe id='inp' name='inp' width='100%' height='100%' scrolling='yes' frameborder='0'>");
let url = '${servletURL}?viewlet=App05/procedure/P_TEMP_TRS_10Y_DEDUCTION_DETAIL.cpt'
iframe.attr("src", url);
var o = {
...
<Listener event="click" name="procedure">
<JavaScript class="com.fr.js.JavaScriptImpl">
<Parameters/>
<Content>
<![CDATA[var iframe = $("<iframe id='inp' name='inp' width='100%' height='100%' scrolling='yes' frameborder='0'>");
let url ='${servletURL}?viewlet=App05/procedure/P_TEMP_TRS_FACT_CFC_RECOGNIZED_AMOUNT.cpt';
iframe.attr("src", url);
var o = {
...
<ForkIdAttrMark forkId="9f3854e6-6bee-4ad1-8812-0679c6ad073b"/>
</ForkIdAttrMark>
<TemplateIdAttMark class="com.fr.base.iofile.attr.TemplateIdAttrMark">
<TemplateIdAttMark TemplateId="9f3854e6-6bee-4ad1-8812-0679c6ad073b"/>
</TemplateIdAttMark>
