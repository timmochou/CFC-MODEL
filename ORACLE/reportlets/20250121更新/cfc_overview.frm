...
select case when t1.SUB_OPE_EXEMPTION = 'true' then 0 
else t1.tax_inc end as tax_inc_sub,
t1.* 
from PROFIT_2 t1]]></Query>
<PageQuery>
<![CDATA[]]></PageQuery>
</TableData>
...
<Widget class="com.fr.form.ui.container.WAbsoluteLayout$BoundsWidget">
<InnerWidget class="com.fr.plugin.form.widget.core.RHIframe" pluginID="com.fr.solution.plugin.form.widget.rh.iframe.v10" plugin-version="8.19">
...
<Attr scrollX="false" scrollY="false" method="POST" contentAdapt="false"/>
<RHIframeAttr class="com.fr.plugin.form.widget.core.RHIframeAttr" pluginID="com.fr.solution.plugin.form.widget.rh.iframe.v10" plugin-version="8.19">
<RHIframeSource class="com.fr.plugin.form.widget.core.TemplateSource" pluginID="com.fr.solution.plugin.form.widget.rh.iframe.v10" plugin-version="8.19">
...
<FillStyleName fillStyleName="Sinopia Extended"/>
...
<ChartDefinition>
<OneValueCDDefinition seriesName="ENTITY_NAME" valueName="TAX_INC_SUB" function="com.fr.data.util.function.SumFunction">
<Top topCate="-1" topValue="-1" isDiscardOtherCate="false" isDiscardOtherSeries="false" isDiscardNullCate="false" isDiscardNullSeries="false"/>
...
<UUID uuid="d6e0c3e2-3d25-4039-87ed-35c905d6e8aa"/>
...
<TemplateIdAttMark TemplateId="51882fda-aeb9-4fad-883a-9beed414c108"/>
</TemplateIdAttMark>
</Form>
